...
export async function POST(
  ...
  try {
    ...
    const quotaSummary = sprint1Storage.getYouTubeQuotaSummary(workspaceId);
    ...
    return NextResponse.json({
      ...
      canUpload: true,
      auditStatus: account.metadataJson?.auditStatus || 'unverified',
      defaultPrivacyStatus: account.metadataJson?.defaultPrivacyStatus || 'private',
      quota: quotaSummary,
    });
  } catch (err: unknown) {
